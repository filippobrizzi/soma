...
if( ProfileTracker x = ProfileTrackParams(47, 0)) {
    ...
    ~PrePostL()
    {
if( ProfileTracker x = ProfileTrackParams(55, 0)) {
        Scalar e = t.elapsed();
        omp_set_lock(&lock);
        std::cerr << x << " exit(" << e <<")\n";
        omp_unset_lock(&lock);
...
{
if( ProfileTracker x = ProfileTrackParams(117, 0)) {
    x = idx % w;
    y = idx / w;
}
}
...
{
if( ProfileTracker x = ProfileTrackParams(128, 0)) {
...
{
if( ProfileTracker x = ProfileTrackParams(137, 0)) {
...
{
if( ProfileTracker x = ProfileTrackParams(145, 0)) {
    return x + y*w;
}
}
...
{
if( ProfileTracker x = ProfileTrackParams(153, 0)) {
...
{
if( ProfileTracker x = ProfileTrackParams(162, 0)) {
...
{
if( ProfileTracker x = ProfileTrackParams(201, 0)) {
...
if( ProfileTracker x = ProfileTrackParams(311, 0)) {
...
{
if( ProfileTracker x = ProfileTrackParams(369, 0)) {
    vertexindex_t vertexindex = getVertexIndexer();
...
{
if( ProfileTracker x = ProfileTrackParams(449, 0)) {
    vertexindex_t vertexindex = getVertexIndexer();
...
{
if( ProfileTracker x = ProfileTrackParams(504, 0)) {
    Scalar* d = X.data();
    cleaner(shells);
...
void Cloth::initMass()
{
if( ProfileTracker x = ProfileTrackParams(520, 0)) {
...
Cloth::Cloth(Configuration & cconf,SimLogger & alogger):
    ...
    logger(alogger)
{    
if( ProfileTracker x = ProfileTrackParams(594, 0)) {
...
Cloth::~Cloth()
{
if( ProfileTracker x = ProfileTrackParams(619, 0)) {
}
}

void Cloth::force(int row, int col, int coordAxis, Scalar f)
{
if( ProfileTracker x = ProfileTrackParams(623, 0)) {
...
{
if( ProfileTracker x = ProfileTrackParams(630, 0)) {
...
{
if( ProfileTracker x = ProfileTrackParams(638, 0)) {
